...
{
  Motor[2].speed = MOTOR_SPEED_MID;
  Motor[2].max_pulse = 11500;
  Motor[2].min_pulse = -6500;
  Motor[2].now_pulse = -6500;
  Motor[2].target_pulse = -6500;
...
{
  Motor[3].max_pulse = 10700;
  Motor[3].min_pulse = -5300;
  Motor[3].now_pulse = -5300;
  Motor[3].target_pulse = -5300;
  Motor[3].speed = MOTOR_SPEED_MID;
